...
export const ITEMS: Prisma.FrenchItemCreateManyInput[] = [
  ...
  },
  {
    ...
    difficulty: "FOUNDATION", topicTag: "vie-pratique",
    payload: { situation: "Vous avez réservé une formation en ligne qui ne correspond pas du tout à la description annoncée.", instruction: "Écrivez au service concerné pour décrire le problème, exprimer votre mécontentement de façon mesurée et demander un remboursement ou une solution.", wordMin: 80, wordMax: 120 },
  },
  {
    level: "B2", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TEF",
    ...
    difficulty: "STRETCH", topicTag: "medias",
    payload: { situation: "Une tribune affirme que « les réseaux sociaux nous informent mieux que les journaux ».", instruction: "Rédigez un texte argumenté qui répond à cette affirmation. Développez votre point de vue, organisez vos arguments et concluez clairement.", wordMin: 200, wordMax: 260 },
  },
  {
    level: "B2", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TEF",
    ...
    payload: { situation: "Vous devez vous absenter une semaine et confier un dossier important à un collègue.", instruction: "Écrivez-lui un message clair : expliquez la situation, donnez les consignes essentielles, indiquez où trouver les informations et remerciez-le.", wordMin: 80, wordMax: 120 },
  },
  {
    ...
    difficulty: "STRETCH", topicTag: "societe",
    payload: { situation: "Sujet : « Le tourisme de masse fait-il plus de bien que de mal aux villes ? »", instruction: "Rédigez un texte argumenté qui développe une position personnelle. Exposez des arguments contrastés avant de conclure de manière nuancée.", wordMin: 120, wordMax: 180 },
  },
  {
    level: "B2", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TCF",
    ...
    difficulty: "CORE", topicTag: "culture",
    payload: { situation: "Le bulletin de votre association vous demande de présenter un événement culturel de votre région.", instruction: "Rédigez un article qui présente l'événement, explique son intérêt et donne envie d'y participer. Soyez clair et structuré.", wordMin: 120, wordMax: 150 },
  },
  {
    level: "B2", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TCF",
    ...
    prompt: "Rédigez votre texte argumenté.",
    difficulty: "CORE", topicTag: "travail",
    payload: { situation: "Sujet : « La semaine de quatre jours devrait-elle se généraliser ? »", instruction: "Rédigez un texte qui présente votre opinion, l'appuie sur des arguments et des exemples, et tient compte d'un avis contraire.", wordMin: 120, wordMax: 180 },
  },
  {
    level: "B2", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TCF",
    ...
    payload: { situation: "Vous souhaitez vous inscrire à une formation et il vous manque plusieurs informations.", instruction: "Écrivez un courriel à l'organisme : présentez-vous brièvement, posez vos questions (dates, tarif, niveau requis, modalités) et demandez une réponse rapide.", wordMin: 120, wordMax: 150 },
  },
  {
    level: "B2", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "DELF_DALF",
  ...
  },
  {
    ...
    payload: { situation: "Sujet : « L'intelligence artificielle va-t-elle améliorer notre travail ? »", instruction: "Rédigez un texte argumenté présentant votre point de vue. Appuyez-vous sur des arguments et anticipez une objection avant de conclure.", wordMin: 200, wordMax: 260 },
  },
  {
    level: "B2", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TCF",
    ...
    difficulty: "CORE", topicTag: "environnement",
    payload: { situation: "Sujet : « Faut-il rendre plus de place à la nature dans les villes ? »", instruction: "Rédigez un texte structuré qui défend une position. Donnez des arguments concrets et un exemple, puis concluez.", wordMin: 120, wordMax: 180 },
  },
  {
    level: "B2", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "DELF_DALF",
  ...
  },
  {
    ...
    difficulty: "CORE", topicTag: "societe",
    payload: { taskPrompt: "On vous demande votre avis sur l'affirmation : « Les grandes villes sont devenues invivables. » Donnez votre point de vue, justifiez-le avec des arguments et illustrez par des exemples.", prepSeconds: 60, speakSeconds: 600 },
  },
  {
    level: "B2", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TEF",
    ...
    prompt: "Jouez la situation à l'oral, puis tapez votre transcription.",
    difficulty: "FOUNDATION", topicTag: "vie-pratique",
    payload: { taskPrompt: "Vous voyez l'annonce d'un programme de formation professionnelle. Vous téléphonez pour obtenir des précisions (contenu, durée, financement possible, débouchés). Posez des questions claires et rebondissez sur les réponses.", prepSeconds: 60, speakSeconds: 300 },
  },
  {
    level: "B2", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TEF",
    ...
    difficulty: "STRETCH", topicTag: "environnement",
    payload: { taskPrompt: "Réagissez à l'affirmation : « Chacun devrait pouvoir voyager autant qu'il le souhaite. » Présentez un point de vue nuancé, avec des arguments et un exemple, puis concluez.", prepSeconds: 60, speakSeconds: 600 },
  },
  {
    level: "B2", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TEF",
    title: "TEF Section B — Persuader : répartir les tâches d'un projet",
    prompt: "Jouez la situation à l'oral, puis tapez votre transcription.",
    difficulty: "CORE", topicTag: "vie-quotidienne",
    payload: { taskPrompt: "Avec un ami, vous organisez une fête de quartier. Vous l'appelez pour vous répartir les tâches : proposez des idées, réagissez aux siennes et mettez-vous d'accord sur un plan.", prepSeconds: 60, speakSeconds: 600 },
  },
  {
    ...
    difficulty: "STRETCH", topicTag: "medias",
    payload: { taskPrompt: "Sujet : « Faut-il se méfier de l'information trouvée sur les réseaux sociaux ? » Donnez votre opinion, développez plusieurs arguments et illustrez par des exemples.", prepSeconds: 0, speakSeconds: 270 },
  },
  {
    level: "B2", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TCF",
    ...
    difficulty: "CORE", topicTag: "vie-quotidienne",
    payload: { taskPrompt: "Comparez la vie en ville et la vie à la campagne. Décrivez les avantages et les inconvénients de chacune, puis dites laquelle vous conviendrait le mieux et pourquoi.", prepSeconds: 120, speakSeconds: 210 },
  },
  {
    level: "B2", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TCF",
    ...
    difficulty: "CORE", topicTag: "travail",
    payload: { taskPrompt: "Sujet : « Vaut-il mieux un travail bien payé ou un travail qui a du sens ? » Présentez votre point de vue, nuancez et appuyez-vous sur des exemples.", prepSeconds: 0, speakSeconds: 270 },
  },
  {
    level: "B2", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TCF",
    ...
    prompt: "Répondez à l'oral, puis tapez votre transcription.",
    difficulty: "FOUNDATION", topicTag: "culture",
    payload: { taskPrompt: "Racontez un événement culturel (concert, exposition, festival) qui vous a marqué. Décrivez-le, expliquez pourquoi il vous a plu et ce qu'il vous a apporté.", prepSeconds: 120, speakSeconds: 210 },
  },
  {
    level: "B2", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "DELF_DALF",
  ...
  },
  {
    ...
    difficulty: "CORE", topicTag: "technologie",
    payload: { taskPrompt: "Réagissez à l'affirmation : « La technologie nous fait gagner du temps. » Présentez un avis nuancé avec des arguments et au moins un exemple, puis concluez.", prepSeconds: 60, speakSeconds: 600 },
  },
  {
    level: "B2", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TCF",
    ...
    difficulty: "CORE", topicTag: "education",
    payload: { taskPrompt: "Sujet : « Le numérique améliore-t-il vraiment l'éducation ? » Développez votre point de vue avec des arguments contrastés et concluez de façon nuancée.", prepSeconds: 0, speakSeconds: 270 },
  },
  {
    level: "B2", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "DELF_DALF",
  ...
  // ---------- TEF B2 top-up (Rule #7: 5 -> 15 per expression module) ----------
  // Fixed TEF format: écrite Section A 80–120 / Section B 200–260; orale Section A
  // 300 s (obtain information) / Section B 600 s (persuade). B2 shifts topic and
  // register only.
  {
    level: "B2", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TEF",
    title: "TEF Section A — Courriel : demander la révision d'une décision",
    prompt: "Rédigez le message demandé (Section A).",
    difficulty: "CORE", topicTag: "travail",
    payload: { situation: "Votre demande de formation a été refusée sans explication détaillée.", instruction: "Écrivez au service des ressources humaines. Rappelez votre demande et sa date, sollicitez les motifs du refus, indiquez en quoi la formation sert votre poste, et demandez un entretien.", wordMin: 80, wordMax: 120 },
  },
  {
    level: "B2", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TEF",
    title: "TEF Section A — Message : signaler un dysfonctionnement récurrent",
    prompt: "Rédigez le message demandé (Section A).",
    difficulty: "CORE", topicTag: "logement",
    payload: { situation: "L'ascenseur de votre immeuble tombe en panne presque chaque semaine.", instruction: "Écrivez au syndic. Décrivez la fréquence et les conséquences pour les résidents concernés, demandez quelles interventions ont déjà eu lieu, et sollicitez un calendrier de remise en état.", wordMin: 80, wordMax: 120 },
  },
  {
    level: "B2", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TEF",
    title: "TEF Section A — Courriel : négocier un délai de livraison",
    prompt: "Rédigez le message demandé (Section A).",
    difficulty: "STRETCH", topicTag: "travail",
    payload: { situation: "Un fournisseur annonce un retard qui compromet un engagement pris auprès d'un client.", instruction: "Écrivez au fournisseur. Rappelez la commande et l'échéance convenue, exposez les conséquences du retard, demandez une livraison partielle, et fixez une date de réponse.", wordMin: 80, wordMax: 120 },
  },
  {
    level: "B2", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TEF",
    title: "TEF Section A — Message : proposer une réorganisation d'équipe",
    prompt: "Rédigez le message demandé (Section A).",
    difficulty: "CORE", topicTag: "travail",
    payload: { situation: "Deux collègues assurent seuls l'accueil, ce qui bloque le service dès qu'un des deux est absent.", instruction: "Écrivez à votre responsable. Décrivez le problème avec des faits, proposez une rotation élargie, indiquez ce qu'elle demanderait comme formation, et sollicitez un essai d'un mois.", wordMin: 80, wordMax: 120 },
  },
  {
    level: "B2", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TEF",
    title: "TEF Section A — Courriel : contester une facture de réparation",
    prompt: "Rédigez le message demandé (Section A).",
    difficulty: "CORE", topicTag: "vie-pratique",
    payload: { situation: "Le montant facturé dépasse largement le devis que vous aviez accepté.", instruction: "Écrivez au garage. Rappelez le devis et son montant, détaillez l'écart constaté, demandez une explication ligne par ligne, et indiquez ce que vous attendez comme régularisation.", wordMin: 80, wordMax: 120 },
  },
  {
    level: "B2", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TEF",
    title: "TEF Section B — Défendre : encadrer la publicité destinée aux enfants",
    prompt: "Rédigez un texte argumenté défendant une position (Section B).",
    difficulty: "STRETCH", topicTag: "societe",
    payload: { situation: "Un projet propose d'interdire la publicité ciblant les moins de douze ans.", instruction: "Défendez une position argumentée. Traitez la liberté commerciale et la protection des enfants, appuyez-vous sur des situations concrètes, et répondez à l'objection de la responsabilité parentale.", wordMin: 200, wordMax: 260 },
  },
  {
    level: "B2", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TEF",
    title: "TEF Section B — Défendre : la formation continue financée par l'employeur",
    prompt: "Rédigez un texte argumenté défendant une position (Section B).",
    difficulty: "CORE", topicTag: "travail",
    payload: { situation: "Une tribune affirme que la formation continue relève d'abord de l'initiative individuelle.", instruction: "Prenez position dans un texte argumenté. Défendez votre thèse avec des arguments économiques et sociaux, concédez ce qui est juste dans la thèse adverse, et concluez fermement.", wordMin: 200, wordMax: 260 },
  },
  {
    level: "B2", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TEF",
    title: "TEF Section B — Défendre : rendre les transports scolaires gratuits",
    prompt: "Rédigez un texte argumenté défendant une position (Section B).",
    difficulty: "CORE", topicTag: "etudes",
    payload: { situation: "Votre région débat de la gratuité totale des transports scolaires.", instruction: "Défendez une position. Traitez le coût public, l'égalité d'accès et les effets sur la circulation, et répondez à l'argument selon lequel la gratuité déresponsabilise les usagers.", wordMin: 200, wordMax: 260 },
  },
  {
    level: "B2", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TEF",
    title: "TEF Section B — Défendre : limiter les locations touristiques de courte durée",
    prompt: "Rédigez un texte argumenté défendant une position (Section B).",
    difficulty: "STRETCH", topicTag: "logement",
    payload: { situation: "Le centre de votre ville se vide de ses habitants au profit des locations de courte durée.", instruction: "Défendez une position argumentée. Pesez l'apport touristique contre la disparition du logement permanent, et répondez à l'objection de la liberté des propriétaires.", wordMin: 200, wordMax: 260 },
  },
  {
    level: "B2", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TEF",
    title: "TEF Section B — Défendre : le bénévolat reconnu dans un parcours professionnel",
    prompt: "Rédigez un texte argumenté défendant une position (Section B).",
    difficulty: "CORE", topicTag: "societe",
    payload: { situation: "Certains employeurs refusent de considérer l'expérience bénévole comme une expérience professionnelle.", instruction: "Défendez une position argumentée. Montrez ce que le bénévolat développe réellement, illustrez par des exemples, et répondez à l'objection de l'absence de cadre professionnel.", wordMin: 200, wordMax: 260 },
  },
  {
    level: "B2", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TEF",
    title: "TEF Section A — Se renseigner : reprendre une activité indépendante",
    prompt: "Posez le maximum de questions utiles (Section A), puis tapez votre transcription.",
    difficulty: "STRETCH", topicTag: "travail",
    payload: { taskPrompt: "Vous envisagez de vous mettre à votre compte. Auprès d'un conseiller, posez le maximum de questions : les statuts possibles, les charges et cotisations, la protection sociale, les aides au démarrage, les obligations comptables, et les délais des démarches.", prepSeconds: 60, speakSeconds: 300 },
  },
  {
    level: "B2", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TEF",
    title: "TEF Section A — Se renseigner : un litige avec un bailleur",
    prompt: "Posez le maximum de questions utiles (Section A), puis tapez votre transcription.",
    difficulty: "STRETCH", topicTag: "logement",
    payload: { taskPrompt: "Votre bailleur refuse de restituer votre dépôt de garantie. Auprès d'une association de défense des locataires, posez le maximum de questions : les délais légaux, les preuves à réunir, les recours amiables puis contentieux, les coûts éventuels, et les délais de traitement.", prepSeconds: 60, speakSeconds: 300 },
  },
  {
    level: "B2", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TEF",
    title: "TEF Section A — Se renseigner : faire garder un parent âgé",
    prompt: "Posez le maximum de questions utiles (Section A), puis tapez votre transcription.",
    difficulty: "CORE", topicTag: "sante",
    payload: { taskPrompt: "Vous cherchez une solution d'accompagnement à domicile pour un parent âgé. Posez le maximum de questions : les prestations proposées, les horaires, la qualification des intervenants, le coût et les aides possibles, la continuité en cas d'absence, et la procédure de mise en place.", prepSeconds: 60, speakSeconds: 300 },
  },
  {
    level: "B2", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TEF",
    title: "TEF Section A — Se renseigner : organiser un séminaire d'entreprise",
    prompt: "Posez le maximum de questions utiles (Section A), puis tapez votre transcription.",
    difficulty: "CORE", topicTag: "travail",
    payload: { taskPrompt: "Vous organisez un séminaire de deux jours pour trente personnes. Auprès d'un prestataire, posez le maximum de questions : les salles et leur capacité, l'hébergement, la restauration et les régimes particuliers, le matériel technique, le devis détaillé, et les conditions d'annulation.", prepSeconds: 60, speakSeconds: 300 },
  },
  {
    level: "B2", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TEF",
    title: "TEF Section A — Se renseigner : faire reconnaître un diplôme étranger",
    prompt: "Posez le maximum de questions utiles (Section A), puis tapez votre transcription.",
    difficulty: "STRETCH", topicTag: "etudes",
    payload: { taskPrompt: "Vous souhaitez faire reconnaître un diplôme obtenu à l'étranger. Posez le maximum de questions : l'organisme compétent, les pièces à fournir, les traductions exigées, les frais, les délais, et la valeur exacte de l'attestation obtenue.", prepSeconds: 60, speakSeconds: 300 },
  },
  {
    level: "B2", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TEF",
    title: "TEF Section B — Persuader : instaurer une semaine sans réunion",
    prompt: "Présentez et convainquez votre interlocuteur (Section B), puis tapez votre transcription.",
    difficulty: "STRETCH", topicTag: "travail",
    payload: { taskPrompt: "Présentez à votre direction l'idée d'une semaine par mois sans réunion interne et convainquez-la. Traitez la concentration, les délais et la coordination. On vous objecte que l'information circulera moins bien — répondez avec une solution précise.", prepSeconds: 60, speakSeconds: 600 },
  },
  {
    level: "B2", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TEF",
    title: "TEF Section B — Persuader : ouvrir la cour de l'école au quartier",
    prompt: "Présentez et convainquez votre interlocuteur (Section B), puis tapez votre transcription.",
    difficulty: "CORE", topicTag: "societe",
    payload: { taskPrompt: "Présentez à la mairie un projet d'ouverture de la cour d'école le week-end et convainquez votre interlocuteur. Traitez l'usage, l'entretien et la sécurité. On vous oppose le risque de dégradations — proposez un cadre crédible.", prepSeconds: 60, speakSeconds: 600 },
  },
  {
    level: "B2", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TEF",
    title: "TEF Section B — Persuader : mutualiser du matériel entre voisins",
    prompt: "Présentez et convainquez votre interlocuteur (Section B), puis tapez votre transcription.",
    difficulty: "CORE", topicTag: "vie-quotidienne",
    payload: { taskPrompt: "Présentez à vos voisins un système de prêt d'outils entre habitants et convainquez-les d'y participer. Traitez le coût, la place et l'entretien. On craint les objets rendus abîmés — proposez des règles simples.", prepSeconds: 60, speakSeconds: 600 },
  },
  {
    level: "B2", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TEF",
    title: "TEF Section B — Persuader : accompagner un collègue en difficulté",
    prompt: "Présentez et convainquez votre interlocuteur (Section B), puis tapez votre transcription.",
    difficulty: "STRETCH", topicTag: "travail",
    payload: { taskPrompt: "Un collègue accumule du retard et s'isole. Présentez à votre responsable un dispositif d'accompagnement plutôt qu'une sanction, et convainquez-le. Il répond que l'équipe en pâtit déjà — traitez cet argument sans le balayer.", prepSeconds: 60, speakSeconds: 600 },
  },
  {
    level: "B2", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TEF",
    title: "TEF Section B — Persuader : choisir une réparation plutôt qu'un remplacement",
    prompt: "Présentez et convainquez votre interlocuteur (Section B), puis tapez votre transcription.",
    difficulty: "CORE", topicTag: "vie-pratique",
    payload: { taskPrompt: "Un proche veut remplacer un appareil encore réparable. Présentez l'option de la réparation et convainquez-le : coût, durée de vie, impact. Il objecte que la réparation coûte presque le prix du neuf — répondez avec des éléments concrets.", prepSeconds: 60, speakSeconds: 600 },
  },

  // ---------- TCF B2 top-up (Rule #7: 5 -> 15 per expression module) ----------
  ...
  {
    level: "B2", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TCF",
    title: "TCF Tâche 1 — Message : alerter sur un risque dans un projet",
    prompt: "Rédigez le message demandé (Tâche 1).",
    difficulty: "CORE", topicTag: "travail",
    payload: { situation: "Un planning que vous avez relu ne laisse aucune marge pour les imprévus.", instruction: "Écrivez au responsable. Signalez le point précis qui vous inquiète, indiquez la conséquence probable, proposez un ajustement, et demandez une décision rapide.", wordMin: 60, wordMax: 120 },
  },
  {
    level: "B2", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TCF",
    title: "TCF Tâche 1 — Message : refuser une demande sans fermer la porte",
    prompt: "Rédigez le message demandé (Tâche 1).",
    difficulty: "STRETCH", topicTag: "travail",
    payload: { situation: "Un partenaire vous demande une remise que vous ne pouvez pas accorder.", instruction: "Écrivez votre réponse. Refusez clairement, expliquez la raison sans vous justifier longuement, proposez une contrepartie possible, et laissez la relation ouverte.", wordMin: 60, wordMax: 120 },
  },
  {
    level: "B2", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TCF",
    title: "TCF Tâche 1 — Message : transmettre une consigne délicate",
    prompt: "Rédigez le message demandé (Tâche 1).",
    difficulty: "CORE", topicTag: "travail",
    payload: { situation: "Une nouvelle règle limite l'usage des salles de réunion, ce qui gênera plusieurs équipes.", instruction: "Écrivez le message d'information. Annoncez la règle, expliquez ce qui la motive, indiquez les solutions de remplacement, et dites à qui s'adresser en cas de difficulté.", wordMin: 60, wordMax: 120 },
  },
  {
    level: "B2", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TCF",
    title: "TCF Tâche 2 — Lettre : contester une décision de refus",
    prompt: "Rédigez le texte demandé (Tâche 2).",
    difficulty: "STRETCH", topicTag: "vie-pratique",
    payload: { situation: "Une demande d'aide au logement vous a été refusée pour un motif qui vous paraît inexact.", instruction: "Écrivez à l'organisme. Rappelez le dossier et la décision, exposez précisément l'erreur constatée, joignez la liste des pièces justificatives, et demandez un réexamen dans un délai indiqué.", wordMin: 120, wordMax: 150 },
  },
  {
    level: "B2", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TCF",
    title: "TCF Tâche 2 — Article : rendre compte d'une enquête interne",
    prompt: "Rédigez le texte demandé (Tâche 2).",
    difficulty: "CORE", topicTag: "travail",
    payload: { situation: "Une enquête auprès du personnel montre une satisfaction en baisse sur l'organisation du travail.", instruction: "Rédigez un article pour le journal interne. Présentez la méthode et le taux de réponse, exposez les résultats principaux sans les enjoliver, rapportez une critique et une suggestion, et annoncez la suite prévue.", wordMin: 120, wordMax: 150 },
  },
  {
    level: "B2", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TCF",
    title: "TCF Tâche 2 — Lettre : proposer un partenariat culturel",
    prompt: "Rédigez le texte demandé (Tâche 2).",
    difficulty: "CORE", topicTag: "societe",
    payload: { situation: "Votre association souhaite organiser des lectures dans une médiathèque municipale.", instruction: "Écrivez à la direction. Présentez l'association et le projet, précisez le public visé et la fréquence, indiquez ce que chaque partie apporterait, et proposez une période d'essai.", wordMin: 120, wordMax: 150 },
  },
  {
    level: "B2", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TCF",
    title: "TCF Tâche 3 — Comparer : le télétravail vu par les deux parties",
    prompt: "Comparez les deux points de vue puis donnez le vôtre (Tâche 3).",
    difficulty: "CORE", topicTag: "travail",
    payload: { situation: "Les salariés y voient un gain de qualité de vie ; des directions y voient une perte de cohésion.", instruction: "Exposez fidèlement les deux analyses et ce qui les fonde, puis défendez une position en tenant compte de ce que l'autre camp a de solide.", wordMin: 120, wordMax: 180 },
  },
  {
    level: "B2", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TCF",
    title: "TCF Tâche 3 — Comparer : la sélection à l'université",
    prompt: "Comparez les deux points de vue puis donnez le vôtre (Tâche 3).",
    difficulty: "STRETCH", topicTag: "etudes",
    payload: { situation: "Les uns défendent une sélection à l'entrée pour éviter les échecs ; les autres y voient une atteinte à l'égalité d'accès.", instruction: "Présentez les deux thèses avec leurs arguments les plus forts, puis prenez position et défendez-la sans caricaturer l'autre camp.", wordMin: 120, wordMax: 180 },
  },
  {
    level: "B2", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TCF",
    title: "TCF Tâche 3 — Comparer : réparer ou remplacer",
    prompt: "Comparez les deux points de vue puis donnez le vôtre (Tâche 3).",
    difficulty: "CORE", topicTag: "societe",
    payload: { situation: "Un débat oppose ceux qui prônent la réparation systématique et ceux qui la jugent peu réaliste économiquement.", instruction: "Exposez les deux positions et leurs justifications, puis défendez la vôtre en tenant compte du coût réel et de l'impact environnemental.", wordMin: 120, wordMax: 180 },
  },
  {
    level: "B2", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TCF",
    title: "TCF Tâche 3 — Comparer : l'évaluation des enseignants par les élèves",
    prompt: "Comparez les deux points de vue puis donnez le vôtre (Tâche 3).",
    difficulty: "STRETCH", topicTag: "etudes",
    payload: { situation: "Certains y voient un retour utile sur la pédagogie ; d'autres craignent un jugement de popularité.", instruction: "Présentez les deux points de vue de manière équilibrée, puis prenez position en précisant à quelles conditions votre solution serait acceptable.", wordMin: 120, wordMax: 180 },
  },
  {
    level: "B2", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TCF",
    title: "TCF Tâche 1 — Entretien guidé : votre rapport à l'information",
    prompt: "Répondez à l'entretien guidé (Tâche 1), puis tapez votre transcription.",
    difficulty: "CORE", topicTag: "societe",
    payload: { taskPrompt: "Parlez de la façon dont vous vous informez : les sources que vous utilisez, à quels moments, ce à quoi vous faites attention, et ce qui a changé ces dernières années.", prepSeconds: 0, speakSeconds: 120 },
  },
  {
    level: "B2", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TCF",
    title: "TCF Tâche 1 — Entretien guidé : une compétence que vous avez acquise",
    prompt: "Répondez à l'entretien guidé (Tâche 1), puis tapez votre transcription.",
    difficulty: "FOUNDATION", topicTag: "travail",
    payload: { taskPrompt: "Parlez d'une compétence que vous avez acquise : comment vous l'avez apprise, ce qui a été difficile, à quoi elle vous sert, et ce que vous conseilleriez à quelqu'un qui débute.", prepSeconds: 0, speakSeconds: 120 },
  },
  {
    level: "B2", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TCF",
    title: "TCF Tâche 1 — Entretien guidé : votre ville dans dix ans",
    prompt: "Répondez à l'entretien guidé (Tâche 1), puis tapez votre transcription.",
    difficulty: "CORE", topicTag: "societe",
    payload: { taskPrompt: "Décrivez votre ville telle que vous l'imaginez dans dix ans : ce qui aura changé, ce que vous espérez, et ce que vous craignez.", prepSeconds: 0, speakSeconds: 120 },
  },
  {
    level: "B2", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TCF",
    title: "TCF Tâche 2 — Interaction : négocier un contrat de prestation",
    prompt: "Posez 8 à 12 questions dans l'échange (Tâche 2), puis tapez votre transcription.",
    difficulty: "STRETCH", topicTag: "travail",
    payload: { taskPrompt: "Vous discutez d'un contrat de prestation. Posez entre 8 et 12 questions : le périmètre exact, les délais, les livrables, les conditions de révision du prix, la propriété des résultats, les pénalités, la confidentialité, et les modalités de rupture.", prepSeconds: 120, speakSeconds: 210 },
  },
  {
    level: "B2", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TCF",
    title: "TCF Tâche 2 — Interaction : préparer un séjour d'études à l'étranger",
    prompt: "Posez 8 à 12 questions dans l'échange (Tâche 2), puis tapez votre transcription.",
    difficulty: "CORE", topicTag: "etudes",
    payload: { taskPrompt: "Vous préparez un semestre d'études à l'étranger. Posez entre 8 et 12 questions : les universités partenaires, la reconnaissance des crédits, le niveau de langue exigé, le logement, les bourses, l'assurance, le calendrier des candidatures, et l'accompagnement sur place.", prepSeconds: 120, speakSeconds: 210 },
  },
  {
    level: "B2", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TCF",
    title: "TCF Tâche 2 — Interaction : signaler un problème de sécurité au travail",
    prompt: "Posez 8 à 12 questions dans l'échange (Tâche 2), puis tapez votre transcription.",
    difficulty: "STRETCH", topicTag: "travail",
    payload: { taskPrompt: "Un équipement de votre service présente un défaut récurrent. Auprès du responsable sécurité, posez entre 8 et 12 questions : la procédure de signalement, les vérifications déjà faites, les mesures provisoires, le délai d'intervention, la traçabilité, les responsabilités, et ce que doit faire l'équipe en attendant.", prepSeconds: 120, speakSeconds: 210 },
  },
  {
    level: "B2", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TCF",
    title: "TCF Tâche 3 — Point de vue : limiter la publicité dans l'espace public",
    prompt: "Exprimez et défendez un point de vue (Tâche 3), puis tapez votre transcription.",
    difficulty: "STRETCH", topicTag: "societe",
    payload: { taskPrompt: "Faut-il réduire fortement la publicité dans les rues et les transports ? Défendez une position argumentée, anticipez l'objection économique, et concluez clairement.", prepSeconds: 0, speakSeconds: 270 },
  },
  {
    level: "B2", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TCF",
    title: "TCF Tâche 3 — Point de vue : la gratuité des transports urbains",
    prompt: "Exprimez et défendez un point de vue (Tâche 3), puis tapez votre transcription.",
    difficulty: "CORE", topicTag: "societe",
    payload: { taskPrompt: "Les transports urbains devraient-ils être gratuits ? Défendez une position en traitant le financement, la fréquentation et l'effet sur la circulation.", prepSeconds: 0, speakSeconds: 270 },
  },
  {
    level: "B2", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TCF",
    title: "TCF Tâche 3 — Point de vue : encadrer le travail des adolescents",
    prompt: "Exprimez et défendez un point de vue (Tâche 3), puis tapez votre transcription.",
    difficulty: "CORE", topicTag: "travail",
    payload: { taskPrompt: "Les adolescents devraient-ils pouvoir travailler pendant l'année scolaire ? Défendez une position argumentée en tenant compte des études, de l'autonomie et du besoin financier.", prepSeconds: 0, speakSeconds: 270 },
  },
  {
    level: "B2", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TCF",
    title: "TCF Tâche 3 — Point de vue : l'anonymat des dons",
    prompt: "Exprimez et défendez un point de vue (Tâche 3), puis tapez votre transcription.",
    difficulty: "STRETCH", topicTag: "societe",
    payload: { taskPrompt: "Vaut-il mieux que les dons aux associations restent anonymes ou qu'ils soient rendus publics ? Défendez une position et répondez à l'argument adverse le plus fort.", prepSeconds: 0, speakSeconds: 270 },
  },
];
