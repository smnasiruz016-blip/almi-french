...
export const ITEMS: Prisma.FrenchItemCreateManyInput[] = [
  ...
  // ---------- TEF C1 top-up (Rule #7: 5 -> 15 per expression module) ----------
  // Fixed TEF format: écrite Section A 80–120 / Section B 200–260; orale Section A
  // 300 s / Section B 600 s. C1 register: abstract framing, concession handled
  // explicitly, precise lexis — the level shows in the answer, not in the task.
  {
    level: "C1", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TEF",
    title: "TEF Section A — Courriel : demander l'accès à un fonds d'archives",
    prompt: "Rédigez le message demandé (Section A).",
    difficulty: "CORE", topicTag: "etudes",
    payload: { situation: "Vos recherches nécessitent la consultation d'un fonds à accès restreint.", instruction: "Écrivez au responsable du fonds. Présentez brièvement votre travail, précisez les documents visés, exposez le motif de la demande, indiquez vos disponibilités, et demandez les conditions de reproduction.", wordMin: 80, wordMax: 120 },
  },
  {
    level: "C1", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TEF",
    title: "TEF Section A — Message : signaler un désaccord méthodologique",
    prompt: "Rédigez le message demandé (Section A).",
    difficulty: "STRETCH", topicTag: "travail",
    payload: { situation: "Les conclusions d'un rapport collectif reposent sur un échantillon que vous jugez insuffisant.", instruction: "Écrivez au pilote du projet. Formulez la réserve avec précision, indiquez ce qu'elle change dans les conclusions, proposez une vérification ciblée, et demandez que la réserve figure au compte rendu.", wordMin: 80, wordMax: 120 },
  },
  {
    level: "C1", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TEF",
    title: "TEF Section A — Courriel : solliciter un droit de réponse",
    prompt: "Rédigez le message demandé (Section A).",
    difficulty: "STRETCH", topicTag: "societe",
    payload: { situation: "Un article vous attribue des propos que vous n'avez pas tenus.", instruction: "Écrivez à la rédaction. Identifiez précisément le passage en cause, rétablissez les faits, demandez une rectification, et précisez le délai et la forme que vous attendez.", wordMin: 80, wordMax: 120 },
  },
  {
    level: "C1", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TEF",
    title: "TEF Section A — Message : proposer une médiation",
    prompt: "Rédigez le message demandé (Section A).",
    difficulty: "CORE", topicTag: "travail",
    payload: { situation: "Deux services de votre organisation se renvoient la responsabilité d'un dossier bloqué.", instruction: "Écrivez aux deux responsables. Décrivez le blocage sans désigner de coupable, proposez une réunion de médiation, fixez un ordre du jour restreint, et demandez une date.", wordMin: 80, wordMax: 120 },
  },
  {
    level: "C1", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TEF",
    title: "TEF Section A — Courriel : demander la révision d'un barème",
    prompt: "Rédigez le message demandé (Section A).",
    difficulty: "CORE", topicTag: "etudes",
    payload: { situation: "Un barème d'évaluation vous paraît pénaliser une compétence pourtant centrale dans le programme.", instruction: "Écrivez au responsable pédagogique. Exposez l'écart entre le barème et les objectifs annoncés, appuyez-vous sur un exemple, proposez un ajustement, et sollicitez un examen en commission.", wordMin: 80, wordMax: 120 },
  },
  {
    level: "C1", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TEF",
    title: "TEF Section B — Prendre parti : l'évaluation par les pairs",
    prompt: "Rédigez un texte argumenté défendant une position (Section B).",
    difficulty: "STRETCH", topicTag: "travail",
    payload: { situation: "Une organisation envisage de confier l'évaluation annuelle aux collègues plutôt qu'à la hiérarchie.", instruction: "Défendez une position argumentée. Traitez l'objectivité, la dynamique d'équipe et le rapport à l'autorité, concédez ce que la thèse adverse a de solide, et tranchez.", wordMin: 200, wordMax: 260 },
  },
  {
    level: "C1", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TEF",
    title: "TEF Section B — Prendre parti : faut-il breveter le vivant ?",
    prompt: "Rédigez un texte argumenté défendant une position (Section B).",
    difficulty: "STRETCH", topicTag: "societe",
    payload: { situation: "Le brevetage de séquences biologiques oppose l'incitation à la recherche et l'accès commun au savoir.", instruction: "Défendez une position argumentée. Distinguez ce qui relève de l'invention et de la découverte, traitez l'incitation économique, et répondez à l'objection de l'accès aux traitements.", wordMin: 200, wordMax: 260 },
  },
  {
    level: "C1", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TEF",
    title: "TEF Section B — Prendre parti : la mesure de la performance publique",
    prompt: "Rédigez un texte argumenté défendant une position (Section B).",
    difficulty: "CORE", topicTag: "societe",
    payload: { situation: "On reproche aux indicateurs chiffrés de déformer l'action publique qu'ils prétendent évaluer.", instruction: "Défendez une position argumentée. Montrez ce que la quantification permet et ce qu'elle masque, illustrez par un domaine précis, et proposez une position tenable.", wordMin: 200, wordMax: 260 },
  },
  {
    level: "C1", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TEF",
    title: "TEF Section B — Prendre parti : l'obsolescence des savoirs professionnels",
    prompt: "Rédigez un texte argumenté défendant une position (Section B).",
    difficulty: "CORE", topicTag: "travail",
    payload: { situation: "Certains soutiennent qu'un savoir professionnel se périme désormais plus vite qu'il ne s'acquiert.", instruction: "Défendez une position argumentée. Interrogez la thèse plutôt que de l'accepter, distinguez les métiers concernés, et concluez sur ce que cela implique pour la formation.", wordMin: 200, wordMax: 260 },
  },
  {
    level: "C1", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TEF",
    title: "TEF Section B — Prendre parti : le patrimoine face à l'usage",
    prompt: "Rédigez un texte argumenté défendant une position (Section B).",
    difficulty: "STRETCH", topicTag: "societe",
    payload: { situation: "Un bâtiment protégé pourrait être transformé en logements, au prix de modifications irréversibles.", instruction: "Défendez une position argumentée. Opposez conservation et usage vivant du patrimoine, traitez le coût public, et répondez à l'argument de la muséification.", wordMin: 200, wordMax: 260 },
  },
  {
    level: "C1", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TEF",
    title: "TEF Section A — Se renseigner : déposer un dossier de financement",
    prompt: "Posez le maximum de questions utiles (Section A), puis tapez votre transcription.",
    difficulty: "STRETCH", topicTag: "travail",
    payload: { taskPrompt: "Vous préparez une demande de financement pour un projet associatif. Auprès de l'organisme instructeur, posez le maximum de questions : les critères d'éligibilité, les pièces exigées, le calendrier d'instruction, les cofinancements acceptés, les modalités de versement, et les obligations de compte rendu.", prepSeconds: 60, speakSeconds: 300 },
  },
  {
    level: "C1", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TEF",
    title: "TEF Section A — Se renseigner : une clause contractuelle ambiguë",
    prompt: "Posez le maximum de questions utiles (Section A), puis tapez votre transcription.",
    difficulty: "STRETCH", topicTag: "vie-pratique",
    payload: { taskPrompt: "Une clause de votre contrat de prestation peut se lire de deux façons. Auprès du service juridique, posez le maximum de questions : l'interprétation retenue, les précédents, ce qui se passe en cas de désaccord, la possibilité d'un avenant, les délais, et les conséquences financières.", prepSeconds: 60, speakSeconds: 300 },
  },
  {
    level: "C1", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TEF",
    title: "TEF Section A — Se renseigner : intégrer un programme de recherche",
    prompt: "Posez le maximum de questions utiles (Section A), puis tapez votre transcription.",
    difficulty: "CORE", topicTag: "etudes",
    payload: { taskPrompt: "Vous envisagez de rejoindre une équipe de recherche. Posez le maximum de questions : les axes de travail, l'encadrement, le financement de la thèse, les obligations d'enseignement, les publications attendues, et les débouchés des anciens doctorants.", prepSeconds: 60, speakSeconds: 300 },
  },
  {
    level: "C1", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TEF",
    title: "TEF Section A — Se renseigner : reprendre une activité existante",
    prompt: "Posez le maximum de questions utiles (Section A), puis tapez votre transcription.",
    difficulty: "STRETCH", topicTag: "travail",
    payload: { taskPrompt: "Vous étudiez la reprise d'un commerce en activité. Auprès du cédant et de son conseil, posez le maximum de questions : les comptes des trois derniers exercices, la clientèle et sa fidélité, l'état du bail, le personnel repris, les dettes éventuelles, et le calendrier de transmission.", prepSeconds: 60, speakSeconds: 300 },
  },
  {
    level: "C1", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TEF",
    title: "TEF Section A — Se renseigner : contester une décision administrative",
    prompt: "Posez le maximum de questions utiles (Section A), puis tapez votre transcription.",
    difficulty: "CORE", topicTag: "vie-pratique",
    payload: { taskPrompt: "Une décision administrative vous est défavorable et vous envisagez un recours. Posez le maximum de questions : les voies de recours ouvertes, les délais impératifs, les pièces à joindre, l'utilité d'un recours gracieux préalable, les frais, et les chances d'aboutir.", prepSeconds: 60, speakSeconds: 300 },
  },
  {
    level: "C1", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TEF",
    title: "TEF Section B — Persuader : publier des données de recherche",
    ...
    payload: { taskPrompt: "Présentez à votre équipe l'ouverture des données de vos travaux et convainquez-la. Traitez la vérifiabilité, la réutilisation et la reconnaissance. On vous objecte le risque de se faire devancer — traitez-le sérieusement.", prepSeconds: 60, speakSeconds: 600 },
  },
  {
    level: "C1", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TEF",
    title: "TEF Section B — Persuader : renoncer à un projet coûteux",
    prompt: "Présentez et convainquez votre interlocuteur (Section B), puis tapez votre transcription.",
    difficulty: "STRETCH", topicTag: "travail",
    payload: { taskPrompt: "Un projet engagé depuis deux ans ne tiendra pas ses promesses. Présentez à la direction l'arrêt du projet et convainquez-la. On vous répond qu'on a déjà trop investi pour renoncer — répondez à cet argument précisément.", prepSeconds: 60, speakSeconds: 600 },
  },
  {
    level: "C1", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TEF",
    title: "TEF Section B — Persuader : confier une responsabilité à un profil atypique",
    prompt: "Présentez et convainquez votre interlocuteur (Section B), puis tapez votre transcription.",
    difficulty: "CORE", topicTag: "travail",
    payload: { taskPrompt: "Vous voulez confier un poste à une candidate dont le parcours ne correspond pas aux critères habituels. Présentez sa candidature et convainquez le comité. On vous oppose le manque d'expérience sectorielle — montrez ce qui compense.", prepSeconds: 60, speakSeconds: 600 },
  },
  {
    level: "C1", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TEF",
    title: "TEF Section B — Persuader : maintenir une activité peu rentable",
    prompt: "Présentez et convainquez votre interlocuteur (Section B), puis tapez votre transcription.",
    difficulty: "STRETCH", topicTag: "societe",
    payload: { taskPrompt: "Une activité culturelle de votre structure coûte plus qu'elle ne rapporte, mais touche un public que rien d'autre n'atteint. Défendez son maintien devant le conseil d'administration. On vous oppose l'équilibre budgétaire — proposez une solution crédible.", prepSeconds: 60, speakSeconds: 600 },
  },
  {
    level: "C1", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TEF",
    title: "TEF Section B — Persuader : rendre un processus plus lent mais plus sûr",
    prompt: "Présentez et convainquez votre interlocuteur (Section B), puis tapez votre transcription.",
    difficulty: "CORE", topicTag: "travail",
    payload: { taskPrompt: "Vous proposez d'ajouter une étape de contrôle qui allongera les délais mais réduira les erreurs. Convainquez votre interlocuteur. Il répond que les clients ne toléreront pas l'attente — traitez cette objection avec des éléments concrets.", prepSeconds: 60, speakSeconds: 600 },
  },

  // ---------- TCF C1 top-up (Rule #7: 4 -> 15 per expression module) ----------
  ...
  {
    level: "C1", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TCF",
    title: "TCF Tâche 1 — Message : nuancer une conclusion trop rapide",
    prompt: "Rédigez le message demandé (Tâche 1).",
    difficulty: "STRETCH", topicTag: "travail",
    payload: { situation: "Une note interne tire d'une hausse ponctuelle une conclusion générale.", instruction: "Écrivez à son auteur. Reconnaissez ce que la note apporte, indiquez précisément la limite du raisonnement, proposez la formulation qui vous paraît exacte, et suggérez la vérification manquante.", wordMin: 60, wordMax: 120 },
  },
  {
    level: "C1", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TCF",
    title: "TCF Tâche 1 — Message : décliner une tribune commune",
    prompt: "Rédigez le message demandé (Tâche 1).",
    difficulty: "STRETCH", topicTag: "societe",
    payload: { situation: "On vous propose de cosigner un texte dont vous approuvez la conclusion mais pas les arguments.", instruction: "Écrivez votre réponse. Déclinez la signature, distinguez l'accord de fond du désaccord de méthode, évitez toute mise en cause personnelle, et proposez une autre forme de soutien.", wordMin: 60, wordMax: 120 },
  },
  {
    level: "C1", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TCF",
    title: "TCF Tâche 1 — Message : demander une clarification budgétaire",
    prompt: "Rédigez le message demandé (Tâche 1).",
    difficulty: "CORE", topicTag: "travail",
    payload: { situation: "Une ligne budgétaire a été réduite sans que le périmètre du travail attendu ait changé.", instruction: "Écrivez au responsable. Exposez l'écart entre moyens et objectifs, demandez lequel des deux doit être ajusté, proposez une priorisation, et sollicitez une réponse écrite.", wordMin: 60, wordMax: 120 },
  },
  {
    level: "C1", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TCF",
    title: "TCF Tâche 2 — Lettre : demander la reconsidération d'un classement",
    prompt: "Rédigez le texte demandé (Tâche 2).",
    difficulty: "STRETCH", topicTag: "etudes",
    payload: { situation: "Un dossier de candidature a été écarté sur un critère appliqué de manière inégale selon les profils.", instruction: "Écrivez à la commission. Rappelez le dossier, exposez l'inégalité de traitement avec des éléments vérifiables, demandez un réexamen, et proposez un critère de substitution défendable.", wordMin: 120, wordMax: 150 },
  },
  {
    level: "C1", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TCF",
    title: "TCF Tâche 2 — Article : présenter une controverse sans la trancher",
    prompt: "Rédigez le texte demandé (Tâche 2).",
    difficulty: "STRETCH", topicTag: "societe",
    payload: { situation: "Une revue vous demande un article de synthèse sur un débat scientifique en cours.", instruction: "Rédigez l'article. Exposez l'état de la controverse, présentez les deux positions et ce qui les sépare réellement, distinguez les faits établis des hypothèses, et indiquez ce qui permettrait de trancher.", wordMin: 120, wordMax: 150 },
  },
  {
    level: "C1", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TCF",
    title: "TCF Tâche 2 — Lettre : répondre à une critique publique",
    prompt: "Rédigez le texte demandé (Tâche 2).",
    difficulty: "STRETCH", topicTag: "travail",
    payload: { situation: "Un article met en cause la méthode d'un travail que vous avez dirigé.", instruction: "Rédigez votre réponse pour publication. Reconnaissez ce qui est fondé dans la critique, rétablissez ce qui est inexact, exposez la méthode réellement suivie, et proposez la vérification qui trancherait.", wordMin: 120, wordMax: 150 },
  },
  {
    level: "C1", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TCF",
    title: "TCF Tâche 3 — Comparer : mérite et égalité des chances",
    prompt: "Comparez les deux points de vue puis donnez le vôtre (Tâche 3).",
    difficulty: "STRETCH", topicTag: "societe",
    payload: { situation: "Les uns défendent une répartition au mérite ; les autres soutiennent que le mérite mesure surtout le point de départ.", instruction: "Restituez les deux thèses dans leur version la plus forte, identifiez le point exact de désaccord, puis prenez position et assumez ce qu'elle coûte.", wordMin: 120, wordMax: 180 },
  },
  {
    level: "C1", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TCF",
    title: "TCF Tâche 3 — Comparer : la culture doit-elle être rentable ?",
    prompt: "Comparez les deux points de vue puis donnez le vôtre (Tâche 3).",
    difficulty: "STRETCH", topicTag: "societe",
    payload: { situation: "Un débat oppose le financement public de la culture à l'exigence d'équilibre économique.", instruction: "Exposez les deux positions avec leurs meilleurs arguments, montrez ce que chacune présuppose, puis défendez la vôtre en indiquant ses limites.", wordMin: 120, wordMax: 180 },
  },
  {
    level: "C1", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TCF",
    title: "TCF Tâche 3 — Comparer : spécialisation ou polyvalence",
    prompt: "Comparez les deux points de vue puis donnez le vôtre (Tâche 3).",
    difficulty: "CORE", topicTag: "travail",
    payload: { situation: "Certains estiment que la spécialisation protège une carrière ; d'autres qu'elle l'expose.", instruction: "Présentez les deux analyses et les évolutions qui les nourrissent, puis défendez une position en distinguant les secteurs où elle vaut de ceux où elle ne vaut pas.", wordMin: 120, wordMax: 180 },
  },
  {
    level: "C1", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TCF",
    title: "TCF Tâche 3 — Comparer : transparence et efficacité de la décision",
    prompt: "Comparez les deux points de vue puis donnez le vôtre (Tâche 3).",
    difficulty: "STRETCH", topicTag: "societe",
    payload: { situation: "On soutient tantôt que la transparence améliore les décisions, tantôt qu'elle les paralyse.", instruction: "Exposez les deux thèses sans les affaiblir, distinguez transparence du processus et du résultat, puis prenez une position argumentée.", wordMin: 120, wordMax: 180 },
  },
  {
    level: "C1", skill: "EXPRESSION_ECRITE", taskType: "WRITING_TASK", examFamily: "TCF",
    title: "TCF Tâche 3 — Comparer : l'usage des classements",
    prompt: "Comparez les deux points de vue puis donnez le vôtre (Tâche 3).",
    difficulty: "CORE", topicTag: "etudes",
    payload: { situation: "Les classements d'établissements guident les choix des familles tout en étant contestés dans leur méthode.", instruction: "Présentez ce que les classements apportent et ce qu'ils déforment, examinez à quelles conditions ils seraient utiles, puis défendez votre position.", wordMin: 120, wordMax: 180 },
  },
  {
    level: "C1", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TCF",
    title: "TCF Tâche 1 — Entretien guidé : une décision difficile",
    prompt: "Répondez à l'entretien guidé (Tâche 1), puis tapez votre transcription.",
    difficulty: "CORE", topicTag: "travail",
    payload: { taskPrompt: "Parlez d'une décision difficile que vous avez eu à prendre : le contexte, les options envisagées, ce qui a emporté votre choix, et ce que vous en retenez.", prepSeconds: 0, speakSeconds: 120 },
  },
  {
    level: "C1", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TCF",
    title: "TCF Tâche 1 — Entretien guidé : un désaccord instructif",
    prompt: "Répondez à l'entretien guidé (Tâche 1), puis tapez votre transcription.",
    difficulty: "STRETCH", topicTag: "societe",
    payload: { taskPrompt: "Parlez d'un désaccord qui vous a fait changer d'avis : le sujet, l'argument qui a porté, ce que vous pensiez avant, et ce que vous en concluez sur la discussion.", prepSeconds: 0, speakSeconds: 120 },
  },
  {
    level: "C1", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TCF",
    title: "TCF Tâche 1 — Entretien guidé : votre rapport au temps",
    prompt: "Répondez à l'entretien guidé (Tâche 1), puis tapez votre transcription.",
    difficulty: "CORE", topicTag: "vie-quotidienne",
    payload: { taskPrompt: "Parlez de votre organisation du temps : ce à quoi vous en consacrez le plus, ce que vous aimeriez changer, et ce qui vous empêche de le faire.", prepSeconds: 0, speakSeconds: 120 },
  },
  {
    level: "C1", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TCF",
    title: "TCF Tâche 2 — Interaction : monter un dossier de financement",
    prompt: "Posez 8 à 12 questions dans l'échange (Tâche 2), puis tapez votre transcription.",
    difficulty: "STRETCH", topicTag: "travail",
    payload: { taskPrompt: "Vous préparez une demande de subvention. Posez entre 8 et 12 questions : les critères d'éligibilité, les dépenses acceptées, le taux de cofinancement, les justificatifs, le calendrier, les indicateurs exigés, les contrôles ultérieurs, et les motifs fréquents de rejet.", prepSeconds: 120, speakSeconds: 210 },
  },
  {
    level: "C1", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TCF",
    title: "TCF Tâche 2 — Interaction : recruter pour un poste sensible",
    prompt: "Posez 8 à 12 questions dans l'échange (Tâche 2), puis tapez votre transcription.",
    difficulty: "STRETCH", topicTag: "travail",
    payload: { taskPrompt: "Vous menez un entretien pour un poste exposé. Posez entre 8 et 12 questions : le parcours, la gestion d'un conflit vécu, la méthode de travail, le rapport à la confidentialité, les attentes, la disponibilité, les références, et les conditions d'intégration.", prepSeconds: 120, speakSeconds: 210 },
  },
  {
    level: "C1", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TCF",
    title: "TCF Tâche 2 — Interaction : engager une procédure amiable",
    prompt: "Posez 8 à 12 questions dans l'échange (Tâche 2), puis tapez votre transcription.",
    difficulty: "CORE", topicTag: "vie-pratique",
    payload: { taskPrompt: "Vous envisagez une médiation avant tout contentieux. Posez entre 8 et 12 questions : le déroulement, la durée, le coût et sa répartition, la confidentialité, la valeur de l'accord obtenu, les recours en cas d'échec, les délais préservés, et les pièces à préparer.", prepSeconds: 120, speakSeconds: 210 },
  },
  {
    level: "C1", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TCF",
    title: "TCF Tâche 3 — Point de vue : l'utilité des grands projets publics",
    prompt: "Exprimez et défendez un point de vue (Tâche 3), puis tapez votre transcription.",
    difficulty: "STRETCH", topicTag: "societe",
    payload: { taskPrompt: "Les grands projets d'infrastructure valent-ils encore leur coût ? Défendez une position argumentée, distinguez les cas, et répondez à l'objection la plus sérieuse.", prepSeconds: 0, speakSeconds: 270 },
  },
  {
    level: "C1", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TCF",
    title: "TCF Tâche 3 — Point de vue : la place de l'erreur dans l'apprentissage",
    prompt: "Exprimez et défendez un point de vue (Tâche 3), puis tapez votre transcription.",
    difficulty: "CORE", topicTag: "etudes",
    payload: { taskPrompt: "Faut-il évaluer moins pour apprendre mieux ? Défendez une position argumentée, évitez le lieu commun, et tenez compte de ce que l'évaluation permet réellement.", prepSeconds: 0, speakSeconds: 270 },
  },
  {
    level: "C1", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TCF",
    title: "TCF Tâche 3 — Point de vue : réguler les contenus en ligne",
    prompt: "Exprimez et défendez un point de vue (Tâche 3), puis tapez votre transcription.",
    difficulty: "STRETCH", topicTag: "societe",
    payload: { taskPrompt: "Qui devrait décider de ce qui peut être publié en ligne ? Défendez une position argumentée en traitant la liberté d'expression et la responsabilité des plateformes.", prepSeconds: 0, speakSeconds: 270 },
  },
  {
    level: "C1", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TCF",
    title: "TCF Tâche 3 — Point de vue : le travail a-t-il perdu son sens ?",
    prompt: "Exprimez et défendez un point de vue (Tâche 3), puis tapez votre transcription.",
    difficulty: "CORE", topicTag: "travail",
    payload: { taskPrompt: "Le rapport au travail s'est-il vraiment dégradé, ou a-t-il seulement changé ? Défendez une position argumentée en interrogeant le constat lui-même.", prepSeconds: 0, speakSeconds: 270 },
  },
  {
    level: "C1", skill: "EXPRESSION_ORALE", taskType: "SPEAKING_TASK", examFamily: "TCF",
    title: "TCF Tâche 3 — Point de vue : peut-on tout mesurer ?",
    prompt: "Exprimez et défendez un point de vue (Tâche 3), puis tapez votre transcription.",
    difficulty: "STRETCH", topicTag: "societe",
