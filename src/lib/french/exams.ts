...
export const EXAMS: Exam[] = [
  ...
  mk("tef-naturalisation", "TEF Naturalisation", "CCI Paris — Le français des affaires", "TEF",
    ...
    "Accepted for naturalisation, but since 1 Jan 2026 the standard is B2 — confirm the current requirement with the French authority."),
  ...
  mk("tcf-irn", "TCF Naturalisation (IRN)", "France Éducation International", "TCF",
    ...
    "Accepted for naturalisation; since 1 Jan 2026 the standard is B2 — confirm with the French authority."),
