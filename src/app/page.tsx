          ...
          <dl className="mt-8 space-y-6">
            {[
              ...
              },
              {
                ...
                a: "TEF, TCF, DELF and DALF, across every CEFR level.",
              },
              {
                q: "Are the Writing and Speaking scores official?",
                a: "No. They are AI criteria-based estimates to guide your preparation — only the official bodies award real results.",
              },
              {
