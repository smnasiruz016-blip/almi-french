    ...
    <div className="space-y-8">
      ...
      <section className="rounded-2xl border border-almi-bg-peach bg-almi-paper p-6 shadow-sm">
        ...
        <p className="mt-1 text-sm text-almi-text-muted">
          The French exam runs at six CEFR levels (A1–C2). This sets the level of your practice
        ...
        <p className="mt-2 text-xs text-almi-text-muted">
          Not sure which level you need? Confirm with the official exam body, your university, or the
          relevant immigration authority (IRCC / MIFI / the French authority).
        </p>
      </section>
      ...
      <section className="rounded-2xl border border-almi-bg-peach bg-almi-bg p-6 text-center">
        <p className="text-sm text-almi-text">Ready to practise for the French exam?</p>
        <Link
          href="/practice"
