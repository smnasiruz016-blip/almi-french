...
export async function generateMetadata({ params }: Params): Promise<Metadata> {
  ...
  return {
    ...
    description: `How students from ${o.name} apply to ${formationHeading(f)} (${f.diplomaType}) at ${f.establishment}${loc ? `, ${loc}` : ""}: the mandatory Campus France «Études en France» procedure and the French requirement (TCF/TEF or DELF/DALF).`,
